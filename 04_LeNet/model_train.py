...
def train_model_process(model, train_dataloader, val_dataloader, num_epochs):
    ...
    # 选择最优参数，保存最优参数的模型
    torch.save(best_model_wts, "/home/ailixia/PycharmProjects/DeepLearning/04_LeNet/best_model.pth")
...
if __name__ == '__main__':
    ...
    # 利用现有的模型进行模型的训练
    train_process = train_model_process(model_Net, train_data, val_data, num_epochs=100)
    # 绘图
